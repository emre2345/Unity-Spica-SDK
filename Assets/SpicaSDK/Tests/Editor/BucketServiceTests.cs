...
namespace SpicaSDK.Tests.Editor
{
    ...
    {
        private string TestBucketDataAsJson =>
        ...
        public IEnumerator Get() => UniTask.ToCoroutine(async delegate
        {
            ...
            Bucket bucket = await bucketService.Get(bucketId);
